		...
		<div id="main-wrapper" class="col-sm-10 pull-right">
			...
			<div class="container-fluid">
				...
				<div class="form-group">
					...
					<div class="col-xs-9">
						<form:input type="text" id="patient.email" path="patient.email" class="form-control input-sm" placeholder="Ingrese su correo electr&oacute;nico"/>
<%-- 	 					<div class="has-error">
	                    	<form:errors path="patient.address" class="help-inline"/>
	                    </div> --%>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-9">
						<form:input type="tel" id="patient.phone" path="patient.phone" class="form-control input-sm" placeholder="Ingrese su tel&eacute;fono"/>
	 					<div class="has-error">
