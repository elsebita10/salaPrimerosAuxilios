				                	...
				                	<br>
					               	<div class="col-xs-6">
										...
										<div class="form-group">
											...
											<div class="col-xs-8">
												<form:input type="text" id="email" path="email" class="form-control input-sm" placeholder="Ingrese su correo electrónico" disabled="true"/>
										   <%-- <div class="has-error">
										...
										<div class="form-group">
											...
											<div class="col-xs-6">
												<form:input type="text" id="phone" path="phone" class="form-control input-sm" placeholder="Ingrese su teléfono" required="required" disabled="true"/>
							 					<div class="has-error">
								...
								<div class="col-xs-offset-2 col-xs-8 col-xs-offset-2 text-center">
				               		...
				               		<div class="form-group">
										...
										<div class="col-xs-4">
											...
											<label class="radio-inline">
												<form:radiobutton id="sameSi" path="same" name="sameRadios" value="true" required="required" disabled="true"/> Sí
											</label>
										</div>
									</div>
									</br>
									...
									<div class="form-group">
										...
										<div class="col-xs-7">
											<form:input type="text" id="ambulance" path="ambulance" class="form-control input-sm" placeholder="Ingrese el número de móvil" disabled="true"/>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-xs-4">
											...
											<label class="radio-inline">
												<form:radiobutton id="trasladoSi" path="patientTransport" name="trasladoRadios" value="true" disabled="true"/> Sí
											</label>
										</div>
									</div>
									</fieldset>								
									<fieldset id="fieldset-traslado">								
										...
										<div class="form-group">
											...
											<div class="col-xs-7">
												<form:input type="text" id="medicalInstitution" path="medicalInstitution" class="form-control input-sm" placeholder="Ingrese el nombre de la institución" disabled="true"/>
											</div>
										</div>
				               		</fieldset>
				               	</div>
